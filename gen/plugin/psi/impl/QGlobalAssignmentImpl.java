...
public class QGlobalAssignmentImpl extends QAstWrapperPsiElement implements QGlobalAssignment {

  public QGlobalAssignmentImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public QUserAssignmentId getUserAssignmentId() {
    return findChildByClass(QUserAssignmentId.class);
  }
