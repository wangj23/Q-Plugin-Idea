...
public class QListImpl extends QAstWrapperPsiElement implements QList {

  public QListImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<QEmptyIndex> getEmptyIndexList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, QEmptyIndex.class);
  }
