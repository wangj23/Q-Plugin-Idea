...
public class QUserFnCallImpl extends QAstWrapperPsiElement implements QUserFnCall {

  public QUserFnCallImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull QVisitor visitor) {
    visitor.visitUserFnCall(this);
  }
  ...
  public QUserId getUserId() {
    return findNotNullChildByClass(QUserId.class);
  }
